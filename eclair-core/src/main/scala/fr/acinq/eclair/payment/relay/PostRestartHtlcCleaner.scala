        ...
        case Origin.Local(id, _) =>
          ...
          nodeParams.db.payments.getOutgoingPayment(id) match {
            ...
            case None =>
              ...
              nodeParams.db.payments.addOutgoingPayment(OutgoingPayment(id, id, None, fulfilledHtlc.paymentHash, None, fulfilledHtlc.amountMsat, dummyFinalAmount, dummyNodeId, Platform.currentTime, None, OutgoingPaymentStatus.Pending))
